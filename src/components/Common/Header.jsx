              ...
              <div className="row">
                <div className="mt-topbar-left clearfix">
                  <ul className="list-unstyled e-p-bx pull-right">
                    <a href="mailto:monumentalbuilding@outlook.com.au">
                      <i className="fa fa-envelope" />
                      monumentalbuilding@outlook.com.au
                    </a>
                ...
                <div className="mt-topbar-right clearfix">
                  <div className="appint-btn">
                    <NavLink to={"/contactus"} className="site-button">
                      Contact Us Today
                    </NavLink>
                  </div>
                </div>
                    ...
                    <div className="contact-nav-form p-a30">
                      ...
                      <div className="full-social-bg">
                        <ul>
                          <li>
                            <NavLink
                              to={"https://www.facebook.com/MonumentalBG"}
                              className="facebook"
                            >
                          ...
                          <li>
                            <NavLink
                              to={"mailto:monumentalbuilding@outlook.com.au"}
                              className="google"
                            >
                          ...
                          <li>
                            <NavLink
                              to={
                                "https://www.instagram.com/monumental_building/?hl=en"
                              }
                              className="instagram"
                            >
